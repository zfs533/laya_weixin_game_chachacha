...
class LevelConfig
{
    ...
    public static getCurrentLevelData():any
    {
        let lv = PlayerData.gamePattern==2 ? PlayerData.doubleLevel:PlayerData.singleLevel;
        let top_level = this.data_level.length;
        lv = lv%top_level;
        lv = lv == 0 ? 1 : lv;
